# Email voice & style — Tyler Baity

The drafting step (SKILL.md Step 7) must follow this. **This is the one place
...
"template tells" so no two emails share a skeleton and none reads like AI.

**Do**
- Write like one person emailing another. Contractions always (I'm, you're,
  it's, that's). Plain words.
- **Vary the structure every single time** — different opening, different
  rhythm, the occasional short fragment. If you lined three of these up, they
  should look unrelated, not fill-in-the-blank.
...
- "in front of thousands of engaged locals"
- "a built-in way to entertain clients and reward your team"
- "under one agreement"
- "caught my attention" as the default opener
...
caught my attention. I run corporate partnerships at Finley Golf Club. For a
company like Fleet Feet, a partnership does two jobs at once: your brand in
front of thousands of engaged Triangle locals, and a built-in way to entertain
...
- **Bryce Jeske has left Finley** (confirmed 2026-07-28), so his 181 accounts
  are a genuine pass-along: *"Your December call with Bryce got passed along to
  me."* Don't dwell on the departure — one clause, then the ask.
